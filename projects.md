...
**Keywords:** thermoregulation, zebrafish, Markov models, large-scale behavior, 2P imaging  
...
### Model discovery to link neural activity and behavior

**Keywords:** explainable ML, representation learning, neural decoding, eLife 2023  
...
### Thermoregulation hardware & experimental design

**Keywords:** instrumentation, data throughput, experiment design  

- Designed and implemented **custom thermal control hardware** and acquisition routines to deliver naturalistic temperature profiles to freely swimming zebrafish.  
- Integrated behavior tracking, stimulus control, and logging into a cohesive pipeline, making it easy for others in the lab to run complex experiments with minimal overhead.  

---

### Complex systems & intelligence (ongoing)
...
More projects (including spin-off tools, code, and public talks) coming soon.
